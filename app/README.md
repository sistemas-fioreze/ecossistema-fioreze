...
Eventos publicados e nao permanentes sao ocultados quando a data de inicio e alcancada. Um agendador do Worker, executado a cada quinze minutos, persiste o status `archived`; criacoes e edicoes com data inicial ja vencida tambem sao gravadas como arquivadas. Eventos permanentes dependem de uma acao administrativa para sair do portal.
