...
class AgentApplication:
    ...
    def show_setup(self):
        ...
        def connect():
            ...
            try:
                ...
                result = api.enroll(hotels[hotel.get()], activation.get(), device.get(), printer.get())
                self.config = {
    ...
    def show_status(self):
        ...
        ttk.Label(frame, text=f"Impressora: {self.config.get('printer_name', '-')}").pack(anchor="w", pady=(6, 0))
