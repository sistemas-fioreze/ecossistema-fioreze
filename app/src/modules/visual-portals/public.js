...
function styleDeclarations(style, prefix) {
  ...
  return Object.entries(map).map(([key, css]) => style[key] == null ? "" : `${prefix}${css}:${typeof style[key] === "number" && key !== "columns" ? `${style[key]}px` : style[key]};`).join("");
}

function visualPortalCss(settings) {
  return `
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:${settings.background_color};color:${settings.text_color};font-family:${settings.font_family};line-height:1.6}a{color:inherit}.skip-link{position:fixed;left:1rem;top:-5rem;z-index:100;background:#fff;color:#111;padding:.7rem 1rem}.skip-link:focus{top:1rem}.site-header{position:absolute;inset:0 0 auto;z-index:10;display:flex;align-items:center;min-height:76px;padding:14px max(24px,env(safe-area-inset-left))}.brand{display:inline-flex;align-items:center;text-decoration:none}.brand img{display:block;max-width:180px;max-height:48px}.brand strong{font-size:1.1rem}.visual-page{--page-width:${widthValue(settings.content_width)};--page-pad:${settings.page_padding}px;--block-gap:${settings.block_gap}px;display:grid;gap:var(--block-gap);min-height:100vh}.visual-block{--align:var(--base-align,left);--width:var(--base-width,content);--background:var(--base-background,transparent);--text:var(--base-text,inherit);--accent:var(--base-accent,${settings.primary_color});--padding-top:var(--base-padding-top,0px);--padding-bottom:var(--base-padding-bottom,0px);--padding-inline:var(--base-padding-inline,var(--page-pad));--gap:var(--base-gap,20px);--min-height:var(--base-min-height,0px);--radius:var(--base-radius,0px);--columns:var(--base-columns,3);margin:0;background:var(--background);color:var(--text);text-align:var(--align);min-height:var(--min-height);padding:var(--padding-top) var(--padding-inline) var(--padding-bottom);border-radius:var(--radius)}.block-inner{width:min(100%,${widthValue(settings.content_width)});margin-inline:auto}.visual-block[style*="--base-width:narrow"] .block-inner{width:min(100%,720px)}.visual-block[style*="--base-width:wide"] .block-inner{width:min(100%,1440px)}.visual-block[style*="--base-width:full"] .block-inner{width:100%}.visual-block h1,.visual-block h2,.visual-block h3,.visual-block p{margin-top:0;overflow-wrap:anywhere}.visual-block h1{font-size:var(--base-heading-size,clamp(2.5rem,7vw,6.5rem));line-height:.98;letter-spacing:0;margin-bottom:1.4rem}.visual-block h2{font-size:var(--base-heading-size,clamp(2rem,4vw,4.2rem));line-height:1.05;letter-spacing:0;margin-bottom:1rem}.visual-block h3{font-size:var(--base-heading-size,1.25rem);line-height:1.2}.visual-block p{max-width:760px;margin-inline:${alignmentMargin("var(--align)")};font-size:var(--base-text-size,inherit)}.eyebrow{font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.12em}.visual-button{display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:.75rem 1.25rem;border:1px solid var(--accent);border-radius:6px;background:var(--accent);color:#fff;text-decoration:none;font-weight:750}.visual-button.is-outline{background:transparent;color:var(--accent)}.visual-button.is-ghost{min-height:auto;padding:.25rem 0;border:0;border-bottom:1px solid currentColor;border-radius:0;background:transparent;color:var(--accent)}.hero-media{display:grid;place-items:center;min-height:inherit;margin:calc(var(--padding-top) * -1) calc(var(--padding-inline) * -1) calc(var(--padding-bottom) * -1);padding:var(--padding-top) var(--padding-inline) var(--padding-bottom);border-radius:inherit;background-position:center;background-size:cover}.hero-copy{position:relative}.visual-hero:has(.hero-media[style]){color:#fff}.visual-image img,.visual-video video{display:block;width:100%;max-height:78vh;border-radius:var(--radius);background:#111}.visual-image .media-cover{aspect-ratio:16/9;object-fit:cover}.visual-image .media-contain{object-fit:contain}.visual-image figcaption{margin-top:.65rem;color:color-mix(in srgb,currentColor 68%,transparent);font-size:.9rem}.gallery-grid{display:grid;grid-template-columns:repeat(var(--columns),minmax(0,1fr));gap:var(--gap)}.gallery-grid img{width:100%;aspect-ratio:1/1;object-fit:cover;border-radius:var(--radius)}.feature-grid{display:grid;grid-template-columns:repeat(var(--columns),minmax(0,1fr));gap:var(--gap)}.feature-grid article{overflow:hidden;background:color-mix(in srgb,var(--background) 82%,#fff);border:1px solid color-mix(in srgb,currentColor 14%,transparent);border-radius:var(--radius,6px);text-align:left}.feature-grid article img{display:block;width:100%;aspect-ratio:4/3;object-fit:cover}.feature-grid article>div{padding:1.25rem}.visual-quote blockquote{max-width:950px;margin:0 auto;font-size:var(--base-heading-size,clamp(1.6rem,3.2vw,3.3rem));line-height:1.2;font-weight:650}.visual-quote figcaption{margin-top:1.25rem}.contact-panel address{display:grid;gap:.35rem;font-style:normal}.divider{display:flex;align-items:center;gap:1rem}.divider span{height:1px;flex:1;background:currentColor;opacity:.22}.divider em{font-style:normal;font-size:.85rem}.visual-spacer{min-height:var(--min-height,48px)}.hide-desktop{display:none}
@media (min-width:761px){.visual-block{--align:var(--desktop-align,var(--base-align,left));--background:var(--desktop-background,var(--base-background,transparent));--text:var(--desktop-text,var(--base-text,inherit));--accent:var(--desktop-accent,var(--base-accent,${settings.primary_color}));--padding-top:var(--desktop-padding-top,var(--base-padding-top,0px));--padding-bottom:var(--desktop-padding-bottom,var(--base-padding-bottom,0px));--padding-inline:var(--desktop-padding-inline,var(--base-padding-inline,var(--page-pad)));--gap:var(--desktop-gap,var(--base-gap,20px));--min-height:var(--desktop-min-height,var(--base-min-height,0px));--radius:var(--desktop-radius,var(--base-radius,0px));--columns:var(--desktop-columns,var(--base-columns,3))}.visual-block h1{font-size:var(--desktop-heading-size,var(--base-heading-size,clamp(2.5rem,7vw,6.5rem)))}.visual-block h2{font-size:var(--desktop-heading-size,var(--base-heading-size,clamp(2rem,4vw,4.2rem)))}.visual-block h3{font-size:var(--desktop-heading-size,var(--base-heading-size,1.25rem))}.visual-block p{font-size:var(--desktop-text-size,var(--base-text-size,inherit))}.visual-quote blockquote{font-size:var(--desktop-heading-size,var(--base-heading-size,clamp(1.6rem,3.2vw,3.3rem)))}}
@media (max-width:760px){.site-header{min-height:64px;padding-inline:max(18px,env(safe-area-inset-left))}.brand img{max-width:142px;max-height:38px}.visual-block{--align:var(--mobile-align,var(--base-align,left));--background:var(--mobile-background,var(--base-background,transparent));--text:var(--mobile-text,var(--base-text,inherit));--accent:var(--mobile-accent,var(--base-accent,${settings.primary_color}));--padding-top:var(--mobile-padding-top,var(--base-padding-top,0px));--padding-bottom:var(--mobile-padding-bottom,var(--base-padding-bottom,0px));--padding-inline:var(--mobile-padding-inline,var(--base-padding-inline,18px));--gap:var(--mobile-gap,var(--base-gap,16px));--min-height:var(--mobile-min-height,var(--base-min-height,0px));--radius:var(--mobile-radius,var(--base-radius,0px));--columns:var(--mobile-columns,1)}.hide-desktop{display:initial}.hide-mobile{display:none}.feature-grid,.gallery-grid{grid-template-columns:repeat(var(--columns),minmax(0,1fr))}.visual-button{width:100%}.visual-block h1{font-size:var(--mobile-heading-size,var(--base-heading-size,clamp(2.45rem,13vw,4.4rem)))}.visual-block h2{font-size:var(--mobile-heading-size,var(--base-heading-size,clamp(2rem,10vw,3rem)))}.visual-block h3{font-size:var(--mobile-heading-size,var(--base-heading-size,1.25rem))}.visual-block p{font-size:var(--mobile-text-size,var(--base-text-size,inherit))}.visual-quote blockquote{font-size:var(--mobile-heading-size,var(--base-heading-size,clamp(1.6rem,8vw,2.4rem)))}}
