...
import { createTestEnv } from "./helpers/mock-d1.js";
...
test("raiz 404 e fallback SPA valido do Pages nao entram em loop de redirect", async () => {
  ...
  assert.deepEqual(requestedAssetPaths, ["/not-found/", "/"]);
});
