...
- página pronta de Eventos, conectada à agenda publicada da unidade, com lista, filtros, consulta por período da estadia, calendário e detalhe editorial;
...
- capa com até quatro ações, títulos, textos, botões, imagens, vídeos, galeria, cards de serviço, evento em destaque, depoimentos, lista com ícones, chamada em destaque, perguntas frequentes, indicadores, linha do tempo, citação, contato, incorporações, divisor e espaçador;
...
- a página e o bloco de Eventos consultam somente a API pública da própria origem, isolada pelo `hotel_slug`; o CTA é aceito apenas quando possui URL HTTPS validada pelo backend;
